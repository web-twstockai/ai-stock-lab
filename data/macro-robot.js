window.MacroRobotData = {
  ...
  "summary": [
    ...
    {
      "label": "下一個事件",
      "value": "Unemployment Benefit Claims (Jun)",
      "unit": "倒數 11 小時",
      "icon": "filter"
    }
  ],
  "events": [
    ...
    },
    {
      ...
      "summary": "ADP 就業人數 將於 2026/07/28 20:15 公布，市場關注前值 16.5、預期 —。",
      "event": "美國 ADP 就業人數，前值 16.5、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "event": "美國 Richmond Fed Manufacturing Index (Jul)，前值 4、預期 10、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響全球資金成本、美元走勢與風險資產評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "GDP 經濟成長率 將於 2026/07/30 13:30 公布，市場關注前值 0.9、預期 0.9。",
      "event": "法國 GDP 經濟成長率，前值 0.9、預期 0.9、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響全球資金成本、美元走勢與風險資產評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "GDP 經濟成長率 將於 2026/07/30 17:00 公布，市場關注前值 0.3、預期 0.4。",
      "event": "歐元區 GDP 經濟成長率，前值 0.3、預期 0.4、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響全球資金成本、美元走勢與風險資產評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "Services Sentiment (Jul) 將於 2026/07/30 17:00 公布，市場關注前值 3.2、預期 3.6。",
      "event": "歐元區 Services Sentiment (Jul)，前值 3.2、預期 3.6、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "初領失業救濟金人數 將於 2026/07/30 20:30 公布，市場關注前值 187、預期 204。",
      "event": "美國 初領失業救濟金人數，前值 187、預期 204、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響就業強弱、薪資通膨與聯準會政策預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "Richmond Fed Manufacturing Shipments Index (Aug) 將於 2026/08/25 22:00 公布，市場關注前值 —、預期 —。",
      "event": "美國 Richmond Fed Manufacturing Shipments Index (Aug)，前值 —、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響全球資金成本、美元走勢與風險資產評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "Richmond Fed Manufacturing Index (Aug) 將於 2026/08/25 22:00 公布，市場關注前值 —、預期 —。",
      "event": "美國 Richmond Fed Manufacturing Index (Aug)，前值 —、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響全球資金成本、美元走勢與風險資產評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "Unemployment Benefit Claims (Jul) 將於 2026/08/27 18:00 公布，市場關注前值 —、預期 —。",
      "event": "法國 Unemployment Benefit Claims (Jul)，前值 —、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響就業強弱、薪資通膨與聯準會政策預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
  ...
  "sourceStatus": {
    ...
    "lookbackDays": 14,
    "horizonDays": 62,
    "calendarWindow": "2026-07-14~2026-09-28",
