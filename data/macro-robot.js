window.MacroRobotData = {
  ...
  "summary": [
    ...
    {
      "label": "下一個事件",
      "value": "Unemployment Benefit Claims (Jul)",
      "unit": "倒數 11 小時",
      "icon": "filter"
    }
  ],
  "events": [
    ...
    },
    {
      ...
      "summary": "PCE 物價指數 將於 2026/08/26 20:30 公布，市場關注前值 -0.1、預期 0.1。",
      "event": "美國 PCE 物價指數，前值 -0.1、預期 0.1、實際 0.2。",
      "ai": "目前 AI 判斷為偏空觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "event": "法國 通膨率，前值 0.6、預期 0.6、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
  ...
  "sourceStatus": {
    ...
    "lookbackDays": 14,
    "horizonDays": 62,
    "calendarWindow": "2026-08-13~2026-10-28",
