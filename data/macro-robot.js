window.MacroRobotData = {
  ...
  "events": [
    ...
    },
    {
      ...
      "summary": "製造業 PMI 將於 2026/07/24 16:30 公布，市場關注前值 —、預期 52。",
      "event": "英國 製造業 PMI，前值 —、預期 52、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "綜合 PMI 將於 2026/07/24 16:30 公布，市場關注前值 —、預期 49.7。",
      "event": "英國 綜合 PMI，前值 —、預期 49.7、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "服務業 PMI 將於 2026/07/24 16:30 公布，市場關注前值 —、預期 49.4。",
      "event": "英國 服務業 PMI，前值 —、預期 49.4、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "服務業 PMI 將於 2026/07/24 21:45 公布，市場關注前值 —、預期 51.5。",
      "event": "美國 服務業 PMI，前值 —、預期 51.5、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "製造業 PMI 將於 2026/07/24 21:45 公布，市場關注前值 —、預期 54.3。",
      "event": "美國 製造業 PMI，前值 —、預期 54.3、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "初領失業救濟金人數 將於 2026/07/30 20:30 公布，市場關注前值 187、預期 206。",
      "event": "美國 初領失業救濟金人數，前值 187、預期 206、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響就業強弱、薪資通膨與聯準會政策預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "核心 PCE 物價指數 將於 2026/07/30 20:30 公布，市場關注前值 4.4、預期 —。",
      "event": "美國 核心 PCE 物價指數，前值 4.4、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "PMI 採購經理人指數 將於 2026/07/31 21:45 公布，市場關注前值 56.7、預期 57.5。",
      "event": "美國 PMI 採購經理人指數，前值 56.7、預期 57.5、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
  ...
  "sourceStatus": {
    ...
    "lookbackDays": 14,
    "horizonDays": 62,
    "calendarWindow": "2026-07-12~2026-09-26",
