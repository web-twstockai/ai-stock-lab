window.MacroRobotData = {
  ...
  "events": [
    ...
    {
      "id": "macro-core-inflation-rate-yoy-jul-20260812",
      "type": "macro",
      "title": "核心通膨率",
      "eventName": "核心通膨率",
      ...
      "summary": "核心通膨率 將於 2026/08/12 20:30 公布，市場關注前值 2.6、預期 2.5。",
      "event": "美國 核心通膨率，前值 2.6、預期 2.5、實際 2.5。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    {
      "id": "macro-ppi-jul-20260813",
      "type": "macro",
      "title": "生產者物價指數 PPI",
      "eventName": "生產者物價指數 PPI",
      "originalEventName": "PPI (Jul)",
      ...
      "summary": "生產者物價指數 PPI 將於 2026/08/13 20:30 公布，市場關注前值 156.607、預期 —。",
      "event": "美國 生產者物價指數 PPI，前值 156.607、預期 —、實際 156.563。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    {
      "id": "macro-ppi-input-yoy-jul-20260819",
      "type": "macro",
      "title": "生產者物價指數 PPI",
      "eventName": "生產者物價指數 PPI",
      "originalEventName": "PPI Input YoY (Jul)",
      "sourcePublishTime": "2026/08/19 14:00 Asia/Taipei",
      "country": "英國",
      "publishTime": "2026/08/19 14:00",
      "previous": "7.4",
      ...
      "summary": "生產者物價指數 PPI 將於 2026/08/19 14:00 公布，市場關注前值 7.4、預期 6.6。",
      "event": "英國 生產者物價指數 PPI，前值 7.4、預期 6.6、實際 4.9。",
      "ai": "目前 AI 判斷為偏空觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "核心 PCE 物價指數 將於 2026/08/26 20:30 公布，市場關注前值 3.3、預期 —。",
    ...
    {
      "id": "macro-pce-price-index-mom-jul-20260826",
      "type": "macro",
      "title": "PCE 物價指數",
      "eventName": "PCE 物價指數",
      "originalEventName": "PCE Price Index MoM (Jul)",
      "sourcePublishTime": "2026/08/26 20:30 Asia/Taipei",
      "country": "美國",
      "publishTime": "2026/08/26 20:30",
      "previous": "-0.1",
      ...
      "summary": "PCE 物價指數 將於 2026/08/26 20:30 公布，市場關注前值 -0.1、預期 —。",
      "event": "美國 PCE 物價指數，前值 -0.1、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "通膨率 將於 2026/09/10 14:00 公布，市場關注前值 0.8、預期 —。",
      "event": "德國 通膨率，前值 0.8、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "生產者物價指數 PPI 將於 2026/09/16 14:00 公布，市場關注前值 0.2、預期 —。",
      "event": "英國 生產者物價指數 PPI，前值 0.2、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
  ...
  "sourceStatus": {
    ...
    "lookbackDays": 14,
    "horizonDays": 62,
    "calendarWindow": "2026-08-06~2026-10-21",
