window.MacroRobotData = {
  ...
  "events": [
    ...
    },
    {
      ...
      "summary": "消費者物價指數 CPI 將於 2026/05/29 20:00 公布，市場關注前值 0.6%、預期 0.1%。",
      "event": "德國 消費者物價指數 CPI，前值 0.6%、預期 0.1%、實際 -0.2%。",
      "ai": "目前 AI 判斷為偏多觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "Investing.com Economic Calendar",
      "sourceUrl": "https://hk.investing.com/economic-calendar/548028",
      "sourceList": [
        "Investing.com Economic Calendar"
      ]
    },
    ...
    },
    {
      ...
      "summary": "ISM 製造業指數 將於 2026/06/03 22:00 公布，市場關注前值 53.6、預期 53.7。",
      "event": "美國 ISM 製造業指數，前值 53.6、預期 53.7、實際 54.5。",
      "ai": "目前 AI 判斷為偏多觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響景氣循環、原物料、工業與科技需求預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "Investing.com Economic Calendar",
    ...
    },
    {
      ...
      "event": "美國 核心通膨率，前值 0.4、預期 0.3、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "event": "美國 通膨率，前值 0.6、預期 0.5、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "核心 CPI 將於 2026/06/10 20:30 公布，市場關注前值 0.4%、預期 0.5%。",
      "event": "美國 核心 CPI，前值 0.4%、預期 0.5%、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "Investing.com Economic Calendar",
    ...
    },
    {
      ...
      "summary": "初領失業救濟金人數 將於 2026/06/11 20:30 公布，市場關注前值 225、預期 225。",
      "event": "美國 初領失業救濟金人數，前值 225、預期 225、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響就業強弱、薪資通膨與聯準會政策預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "生產者物價指數 PPI 將於 2026/06/11 20:30 公布，市場關注前值 1、預期 0.4。",
      "event": "美國 生產者物價指數 PPI，前值 1、預期 0.4、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar / Investing.com Economic Calendar / 鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "消費者物價指數 CPI 將於 2026/06/12 14:00 公布，市場關注前值 -0.2%、預期 -0.2%。",
      "event": "德國 消費者物價指數 CPI，前值 -0.2%、預期 -0.2%、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "Investing.com Economic Calendar",
    ...
    },
    {
      ...
      "event": "英國 消費者物價指數 CPI，前值 2.8%、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "Investing.com Economic Calendar",
    ...
    },
    {
      ...
      "event": "美國 失業率，前值 8.1、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響全球資金成本、美元走勢與風險資產評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "非農就業人數 將於 2026/07/02 20:30 公布，市場關注前值 7、預期 —。",
      "event": "美國 非農就業人數，前值 7、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響就業強弱、薪資通膨與聯準會政策預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "生產者物價指數 PPI 將於 2026/07/06 17:00 公布，市場關注前值 4.9、預期 —。",
      "event": "歐元區 生產者物價指數 PPI，前值 4.9、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "服務業 PMI 將於 2026/07/06 21:45 公布，市場關注前值 50.7、預期 —。",
      "event": "美國 服務業 PMI，前值 50.7、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
    ...
    },
    {
      ...
      "summary": "綜合 PMI 將於 2026/07/06 21:45 公布，市場關注前值 51.5、預期 —。",
      "event": "美國 綜合 PMI，前值 51.5、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
    ...
    },
    {
      ...
      "summary": "服務業 PMI 將於 2026/07/06 22:00 公布，市場關注前值 54.5、預期 —。",
      "event": "美國 服務業 PMI，前值 54.5、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響景氣循環、原物料、工業與科技需求預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    },
    {
      ...
      "summary": "ADP 就業人數 將於 2026/07/07 20:15 公布，市場關注前值 —、預期 —。",
      "event": "美國 ADP 就業人數，前值 —、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響市場風險偏好與資金輪動。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
  ...
  "sourceStatus": {
    ...
    "lookbackDays": 14,
    "horizonDays": 62,
    "calendarWindow": "2026-05-25~2026-08-09",
