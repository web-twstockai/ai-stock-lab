window.MacroRobotData = {
  ...
  "events": [
    ...
    },
    {
      ...
      "event": "英國 GDP 經濟成長率，前值 0.8、預期 0.7、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響景氣循環、原物料、工業與科技需求預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "鉅亨網全球經濟指標",
    ...
    },
    {
      ...
      "summary": "初領失業救濟金人數 將於 2026/06/18 20:30 公布，市場關注前值 1795、預期 —。",
      "event": "美國 初領失業救濟金人數，前值 1795、預期 —、實際 尚未公布。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響就業強弱、薪資通膨與聯準會政策預期。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
  ...
  "sourceStatus": {
    ...
    "lookbackDays": 14,
    "horizonDays": 62,
    "calendarWindow": "2026-05-31~2026-08-15",
