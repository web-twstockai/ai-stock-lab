window.IntelligenceOverviewData = {
  ...
  "macroEvents": [
    ...
    {
      "id": "macro-unemployment-rate-jun-20260630",
      "type": "macro",
      "title": "失業率",
      "eventName": "失業率",
      "originalEventName": "Unemployment Rate (Jun)",
      "sourcePublishTime": "2026/06/30 15:55 Asia/Taipei",
      "country": "德國",
      "publishTime": "2026/06/30 15:55",
      "previous": "6.3",
      "forecast": "6.3",
      "actual": "6.3",
      "status": "已公布",
      ...
      "summary": "失業率 將於 2026/06/30 15:55 公布，市場關注前值 6.3、預期 6.3。",
      "event": "德國 失業率，前值 6.3、預期 6.3、實際 6.3。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響全球資金成本、美元走勢與風險資產評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    {
      "id": "macro-unemployment-change-jun-20260630",
      "type": "macro",
      "title": "就業人數變化",
      "eventName": "就業人數變化",
      "originalEventName": "Unemployment Change (Jun)",
      "sourcePublishTime": "2026/06/30 15:55 Asia/Taipei",
      "country": "德國",
      "publishTime": "2026/06/30 15:55",
      "previous": "-12",
      ...
      "summary": "就業人數變化 將於 2026/06/30 15:55 公布，市場關注前值 -12、預期 10。",
      "event": "德國 就業人數變化，前值 -12、預期 10、實際 -1。",
      "ai": "目前 AI 判斷為偏空觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
    ...
    {
      "id": "macro-brandenburg-cpi-yoy-jun-20260630",
      "type": "macro",
      "title": "消費者物價指數 CPI",
      "eventName": "消費者物價指數 CPI",
      "originalEventName": "Brandenburg CPI YoY (Jun)",
      "sourcePublishTime": "2026/06/30 16:00 Asia/Taipei",
      "country": "德國",
      "publishTime": "2026/06/30 16:00",
      "previous": "2.8",
      "forecast": "—",
      "actual": "2.4",
      "status": "已公布",
      ...
      "summary": "消費者物價指數 CPI 將於 2026/06/30 16:00 公布，市場關注前值 2.8、預期 —。",
      "event": "德國 消費者物價指數 CPI，前值 2.8、預期 —、實際 2.4。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
    ...
    {
      "id": "macro-inflation-rate-mom-prel-jun-20260630",
      "type": "macro",
      "title": "通膨率",
      "eventName": "通膨率",
      "originalEventName": "Inflation Rate MoM Prel (Jun)",
      "sourcePublishTime": "2026/06/30 20:00 Asia/Taipei",
      "country": "德國",
      "publishTime": "2026/06/30 20:00",
      "previous": "-0.2",
      "forecast": "2.6",
      "actual": "-0.3",
      "status": "已公布",
      ...
      "impact": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "importance": "中高",
      "timestamp": "2026/06/30 20:00",
      "tags": [
        "德國",
        "通膨率",
        "中性"
      ],
      "summary": "通膨率 將於 2026/06/30 20:00 公布，市場關注前值 -0.2、預期 —。",
      "event": "德國 通膨率，前值 -0.2、預期 —、實際 -0.3。",
      "ai": "目前 AI 判斷為中性觀察；若實際值與預期差距擴大，台股科技、金融與原物料族群可能出現資金重估。",
      "impactDetail": "影響美債殖利率、降息預期、科技股與金融股評價。",
      "risk": "總經數據公布前後波動容易放大，需留意市場預期差與政策口徑變化。",
      "source": "TradingView Economic Calendar",
